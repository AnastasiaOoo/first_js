document.addEventListener('DOMContentLoaded', () => {
    ...
    var FIGURES = [
        ...
        {
            cells: [1, 2, BOARDWIDTH, BOARDWIDTH+1, BOARDWIDTH*2+1],
            width: 3,
            color: 'qFigure',
        },
        {
        ...
        {
            cells: [0, 1, 2, BOARDWIDTH+1, BOARDWIDTH*2+1],
            width: 3,
            color: 'eFigure',
        },
        {
            cells: [0, 2, BOARDWIDTH, BOARDWIDTH+1, BOARDWIDTH+2],
            width: 3,
            color: 'rFigure',
        },
        {
            cells: [0, BOARDWIDTH, BOARDWIDTH*2, BOARDWIDTH*2+1, BOARDWIDTH*2+2],
            width: 3,
            color: 'yFigure',
        },
        {
            cells: [0, BOARDWIDTH, BOARDWIDTH+1, BOARDWIDTH*2+1, BOARDWIDTH*2+2],
            width: 3,
            color: 'aFigure',
        },
        {
    ...
    var userElement = document.getElementById('rec');
    ...
    function renderCounters() {
        ...
        userElement.innerHTML = 'Лучший результат: ' + betterScore();
    }
    ...
    function betterScore(){
        if (userArray.length == 0){
            var userNameAndScore = 0;
                return userNameAndScore;
        }else{
        
            for(var i = 0; i < userArray.length; i++){
                userNameAndScore = userArray[0];
                var firstResult = userArray[0].score;
                
                if(firstResult >= userArray[i].score){
                    continue;
                }else{
                    firstResult = userArray[i].score;
                    userNameAndScore = userArray[i];
                }
            }
            var lineInfo = userNameAndScore.name + ' счет  -  ' + userNameAndScore.score; 
        }
        return lineInfo;
